<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Update Data Pegawai</h3>
      ...
      <input type="text" class="form-control" placeholder="Client Profile" name="profile" aria-describedby="sizing-addon2" value="<?php echo $dataPegawai->profile_pegawai; ?>">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
      </span>
      <input type="text" class="form-control" placeholder="Client Email" name="email" aria-describedby="sizing-addon2" value="<?php echo $dataPegawai->email_pegawai; ?>">
    </div>
        <div class="input-group form-group">
          <span class="input-group-addon" id="sizing-addon2">
      ...
      <input type="text" class="form-control" placeholder="Ref Id" name="ref_id" aria-describedby="sizing-addon2" value="<?php echo $dataPegawai->ref_id_pegawai; ?>">
    </div>
      ...
      <textarea class="form-control" placeholder="Message" name="message" aria-describedby="sizing-addon2"><?php echo $dataPegawai->message_pegawai; ?></textarea>
    </div>
