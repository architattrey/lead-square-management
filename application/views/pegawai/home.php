...
<div class="box">
  <div class="box-header">
    <div class="col-md-6" style="padding: 0;">
        <button class="form-control btn btn-primary" data-toggle="modal" data-target="#tambah-pegawai"><i class="glyphicon glyphicon-plus-sign"></i> Add Lead</button>
    </div>
    <!-- <div class="col-md-3">
...
<?php show_my_confirm('konfirmasiHapus', 'hapus-dataPegawai', 'Delete ?', 'Yes'); ?>
<?php
  $data['judul'] = 'Pegawai';
